...
content = re.sub(r'(val03Text: "Librairie Nadine has served students, teachers, and schools throughout Zahlé, the Bekaa, and beyond. The bookshop has supported educational workshops and community initiatives, sponsored regional sport, and built trusted distribution relationships that help bring learning materials to the communities that need them.",)', r'\1' + en_add, content)

content = re.sub(r'(val03Text: "La Librairie Nadine a servi des étudiants, des enseignants et des écoles dans tout Zahlé, la Bekaa et au-delà. La librairie a soutenu des ateliers éducatifs et des initiatives communautaires, parrainé le sport régional et établi des relations de distribution de confiance qui contribuent à apporter du matériel d\'apprentissage aux communautés qui en ont besoin.",)', r'\1' + fr_add, content)

content = re.sub(r'(val03Text: "خدمت مكتبة نادين الطلاب والمعلمين والمدارس في جميع أنحاء زحلة والبقاع وما وراءها. دعمت المكتبة ورش العمل التعليمية والمبادرات المجتمعية، ورعت الرياضة الإقليمية، وبنت علاقات توزيع موثوقة تساعد في جلب المواد التعليمية إلى المجتمعات التي تحتاج إليها.",)', r'\1' + ar_add, content)
